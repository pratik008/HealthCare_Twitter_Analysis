...
def findCooccurences():
    ...
    for singleInputLine in inputFileHandle:
        ...
        if inputWord1 in tempTweetDict and inputWord2 in tempTweetDict:
...
def writeToFile(aDict):
    try:
        ...
        print("{}".format(e))
    for connection in aDict[inputWord1]:
        outputList = []
        outputList.append(inputWord1)
        outputList.append(' : ')
        outputList.append(connection)
        outputList.append(',')
        outputList.append(str(aDict[inputWord1][connection]))
        outputList.append('\n')
...
inputWord1 = raw_input('Please Enter a word: ').lower()
inputWord2 = raw_input('Please Enter a word: ').lower()
processedPath  = 'processed/'
outputFileName = 'co-occurrence intersection-' + inputWord1 + '-' + inputWord2 + '.csv'
